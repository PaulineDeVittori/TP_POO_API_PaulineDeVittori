...
public class MeteoService {
    ...
    public ArrayList<String> obtenirAdresse(String address) throws Exception{
        ...
        if (response.getStatusCode().is2xxSuccessful()) {
            ...
            ReponseApi reponseApi = objectMapper.readValue(json, ReponseApi.class);

            if (reponseApi.getFeatures() != null && !reponseApi.getFeatures().isEmpty()) {
                ReponseApi.Feature firstFeature = reponseApi.getFeatures().get(0);
    ...
    public ArrayList<String> ObtenirMeteo(String latitude, String longitude){
        String apiUrl = "https://api.meteo-concept.com/api/forecast/daily";
        String token = "262170ba12d5e571bf79481df7d3d819eab76c4ff2c5513874719e823dee0117";
